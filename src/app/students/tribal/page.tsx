...
export default async function TribalStudentsPage() {
  ...
  // 4. Fetch assigned tribal students (or all if admin)
  let query = supabase.from("Student").select("*").eq("isTribal", true);
